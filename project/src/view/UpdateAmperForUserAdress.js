        ...
        <>
            <Line height="100%">
                <Grid> 
                    ...
                    <Button onClick={clearAll} style={{ width: 40 }}><ArrowForwardIcon /></Button>
                    <div>
                    <p>כמות אמפר:</p>
                    <input style={{marginBottom:'5px'}} value={amperInputValue} onChange={(event) => setAmperInputValue(event.target.value)} disabled={show} />
                    ...
                    <br/>
                    <Button style={{backgroundColor: '#575151', color: 'white', width:'100%'}} 
                    onClick={handleUpdateClick}>עדכן</Button>
                    </div>
                    </div>
                </Grid>
            </Line>
